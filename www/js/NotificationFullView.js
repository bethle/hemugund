var NotificationFullView = function(headers) {
    this.initialize = function() {
        // Define a div wrapper for the view. The div wrapper is used to attach events.
        this.el = document.createElement('div');
        this.el.innerHTML = NotificationFullView.template();
        this.registerEvents();
    };
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.response === "SUCCESS") {
                    $(".search-header-list").html(NotificationFullView.liTemplate(data.result));
                } else {
...
NotificationFullView.template = Handlebars.compile(document.getElementById("notification-full-view-tpl").innerHTML);
NotificationFullView.detailTemplate = Handlebars.compile(document.getElementById("notification-detail-tpl").innerHTML);
